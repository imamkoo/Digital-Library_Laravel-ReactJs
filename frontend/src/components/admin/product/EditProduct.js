...
function EditProduct(props) {
  ...
  const updateProduct = (e) => {
    ...
    formData.append("available", allcheckbox.available ? "1" : "0");
    formData.append("rented", allcheckbox.rented ? "1" : "0");
    formData.append("broken", allcheckbox.broken ? "1" : "0");
                ...
                <div className="row">
                  ...
                  <div className="col-md-4 form-group mb-3">
                    ...
                    <input
                      ...
                      defaultChecked={
                        allcheckbox.available === 1 ? true : false
                      }
                      className="w-50 h-50"
                    />
                  </div>
                  <div className="col-md-4 form-group mb-3">
                    ...
                    <input
                      ...
                      name="rented"
                      onChange={handleCheckbox}
                      defaultChecked={allcheckbox.rented === 1 ? true : false}
                      className="w-50 h-50"
                    />
                  </div>
                  <div className="col-md-4 form-group mb-3">
                    ...
                    <input
                      ...
                      name="broken"
                      onChange={handleCheckbox}
                      defaultChecked={allcheckbox.broken === 1 ? true : false}
                      className="w-50 h-50"
                    />
                  </div>
                </div>
